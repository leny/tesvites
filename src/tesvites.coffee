...
options[ "max-time" ] = program[ "max-time" ] if program[ "max-time" ]
options[ "ping-count" ] = program[ "ping-count" ] if program[ "ping-count" ]
options.servers = program.servers if program.servers
